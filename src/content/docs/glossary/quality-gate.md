...
selfTests:
  - id: "quality-gate-check-1"
    question: "质量门禁最适合阻断哪类问题？"
    options:
      - "构建失败、核心测试失败和高风险安全问题"
      - "所有文案标点问题"
      - "任何非核心样式建议"
      - "所有无需验证的想法"
    correctIndex: 0
    explanation: "质量门禁应优先阻断高风险问题，次要问题可以警告或审批跳过。"
  - id: "quality-gate-check-2"
    question: "为什么质量门禁要前移到合并或提测阶段？"
    options:
      - "问题越早发现，影响范围和修复成本越低"
      - "为了跳过发布前验证"
      - "为了让流水线一定更慢"
      - "为了减少单元测试"
    correctIndex: 0
    explanation: "门禁前移能在变更影响还小时拦截问题，避免生产前集中爆雷。"
  - id: "quality-gate-check-3"
    question: "门禁失败反馈应该包含什么？"
    options:
      - "失败检查项、原因和修复建议"
      - "只显示一个红色状态"
      - "只通知管理者"
      - "隐藏具体日志"
    correctIndex: 0
    explanation: "可定位的反馈能帮助开发快速修复，也能提升团队对门禁的信任。"
