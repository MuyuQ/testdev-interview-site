...
常见的门禁类型（单元测试[覆盖率](/testdev-interview-site/glossary/test-coverage/)、静态代码扫描、安全扫描、接口[测试通过率](/testdev-interview-site/glossary/quality-gate/)）。
...
测试用例分层和执行策略（[smoke 测试](/testdev-interview-site/glossary/smoke-testing/)、[回归测试](/testdev-interview-site/glossary/regression-testing/)、专项测试）。
...
代码提交触发阶段（5-10 分钟）包含单元测试、静态代码检查、接口 [smoke 测试](/testdev-interview-site/glossary/smoke-testing/)，快速验证基础质量。

合并请求触发阶段（30 分钟-1 小时）包含接口[回归测试](/testdev-interview-site/glossary/regression-testing/)、UI 关键路径测试，验证功能完整性。
