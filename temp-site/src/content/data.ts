        ...
        items: [
          {
            ...
            answer: "这是一个企业内部 OA 系统的后台，用户角色包括管理员、部门主管、普通员工。回答时从认证层开始：账号密码 + 图形验证码，密码错误 5 次锁定 15 分钟，管理员支持双因素认证。授权层说明：菜单按角色配置，接口层做权限注解校验，数据权限通过部门 ID 过滤。风控层提到：异常 IP 登录告警、异地登录检测、登录日志审计。会话层说明：JWT token 有效期 2 小时，滑动续期，主动登出后 token 立即加入黑名单。\n\n最后总结测试重点：越权访问、token 泄露风险、日志完整性。",
          },
          {
