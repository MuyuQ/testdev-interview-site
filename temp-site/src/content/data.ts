        ...
        items: [
          {
            ...
            answer: "Redis 测试不是简单的读写验证，要覆盖：缓存命中/未命中场景、缓存更新策略、过期和淘汰行为、缓存异常（连接失败、超时）的兜底、并发访问下的正确性。\n\n每种场景都有不同的测试设计，要展示完整的测试思路。",
          },
          {
