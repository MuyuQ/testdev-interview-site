    ...
    sections: [
      // ========== 模块 1：基础入门 ==========
      {
        ...
        content: [
          ...
          { type: "text", content: "\n\n" },
          { type: "text", content: "举个例子：支付回调接口收到同一笔支付的多次回调通知，幂等设计能保证只处理一次——数据库只有一条支付记录、订单只发货一次、用户只收到一次通知。\n\n这就是幂等的价值：让系统能够安全地处理重复请求。" },
          { type: "text", content: "\n\n" },
  ...
  },
  {
    ...
    sections: [
      // ========== 模块 1：基础入门 ==========
      {
        ...
        kind: "paragraph",
        content: [
          { type: "text", content: "质量门禁（Quality Gate）是 CI/CD 流水线中的关键机制，用于在发布前自动检查代码质量、测试通过率、安全扫描等指标，确保只有符合质量标准的代码才能进入生产环境。\n\n它的核心作用是：阻止高风险变更直接发布，让质量问题在最早阶段被发现和修复。" },
          { type: "text", content: "\n\n" },
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            question: "你学到了什么",
            answer: "掌握了 Playwright 的基本流程：打开页面、定位元素、执行操作、验证结果。\n\n理解了自动等待的价值：代码简洁、稳定性高。下一步是学习 Page Object 模式组织代码。",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    sections: [
      // ========== 模块1：基础入门 ==========
      {
        ...
        kind: "paragraph",
        content: text(
          "性能测试是通过模拟用户负载来评估系统响应速度、吞吐量和稳定性的测试方法。\n\n核心目标是回答三个问题：系统在预期负载下能否正常运行？系统的性能瓶颈在哪里？系统能支撑多少用户？" +
